<h2><a href="https://practice.geeksforgeeks.org/problems/ipl-2021-match-day-2--141634/1?page=1&category[]=Queue&sortBy=submissions">IPL 2021 - Match Day 2</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Due to the rise of covid-19 cases in India, this year BCCI decided to organize knock-out matches in IPL rather than a league. </span></p>
